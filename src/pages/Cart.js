  ...
  return (
    <section className="">
      <div className="container max-w-5xl mx-auto mt-4 p-5 md:p-5">
        ...
        {!CartProduct.length && (
          <h1 className="text-center mt-2">Cart Empty. Please Add Items 😎</h1>
        )}
                ...
                <div className="flex justify-center sm:justify-start">
                  ...
                  <div className=" sm:w-8/12">
                    ...
                    <div className="flex space-x-4 items-center mt-2">
                      <div
                        className="bg-gray-100 px-4 cursor-pointer"
                        onClick={() => dispatch(onDecrease(product._id))}
                      >
                      ...
                      <div
                        className="bg-gray-100 px-4 cursor-pointer"
                        onClick={() => dispatch(onIncrease(product))}
                      >
